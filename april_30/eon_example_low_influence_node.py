...
G = nx.DiGraph()  # Using a directed graph for directional spread simulation
print("Creating graph...")

# Add nodes using string IDs
...
# ==============================================================================
# STEP 3: Define SIR Simulation Parameters
# ==============================================================================

tau = 0.2    # Probability of infection per edge per unit time
gamma = 0.05 # Probability of recovery per unit time
print(f"Model parameters set: tau = {tau}, gamma = {gamma}")

# ==============================================================================
# STEP 4: Choose a Low-Influence Initial Node
# ==============================================================================

# Based on prior centrality analysis, node 103 is chosen due to low degree/centrality
...
# ==============================================================================
# STEP 6: Display Final Simulation Results
# ==============================================================================
...
# ==============================================================================
# STEP 7: Plot Time Series for SIR Compartments
# ==============================================================================
